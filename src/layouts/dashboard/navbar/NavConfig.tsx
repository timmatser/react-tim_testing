...
const ICONS = {
  ...
  searchFill: getIcon('ic_search_fill'),
};
...
const navConfig = [
  ...
  // ----------------------------------------------------------------------
  {
    ...
    items: [
      ...
      { title: 'verkoop', path: PATH_DASHBOARD.order.root, icon: ICONS.order },
      {
        title: 'zoek bestelling',
        path: PATH_DASHBOARD.order.search,
        icon: ICONS.searchFill,
      },
      { title: 'producten', path: PATH_DASHBOARD.product.root, icon: ICONS.cart },
